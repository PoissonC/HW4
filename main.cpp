...
const static char DEVICE_NAME[] = "hw4Test";
...
private:
    ...
    UUID _magnometer_uuid;
    uint16_t _heartrate_value;
    uint16_t _Magnometer_value;
    HeartRateService _heartrate_service;
    MagService _magnometer_service;
